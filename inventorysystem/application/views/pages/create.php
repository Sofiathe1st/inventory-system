...
<label><h2>Create User</h2></label>
  <label>Firstname</label>
    <input type="text" name="firstname" value="" placeholder="Firstname" required id="input_1" />

  <label>Lastname</label>
    <input type="text" name="lastname" value="" placeholder="Lastname" required id="input_1"/>

  <label>Middlename</label>
    <input type="text" name="middlename" value="" placeholder="Middlename" required id="input_1"/>
  ...
  <label>Username</label>
    <input type="text" name="username" value="" placeholder="Username" required id="input_1"/>
  <label>Password</label>
    <input type="password" name="password" value="" placeholder="Password" required id="input_1"/>
  <label>Email</label>
    <input type="email" name="email" value="" placeholder="Email" required id="input_1"/>
