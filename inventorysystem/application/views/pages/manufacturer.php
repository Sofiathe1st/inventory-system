            ...
            <?php if(is_array($manufacturer_list)) { 
                ...
                foreach ($manufacturer_list as $row) { ?>
                 ...
                 <tr>
                    ...
                    <td><a href="<?php echo base_url() ?>index.php/login/edit_manufacturer_details/<?php echo $row->id ?>" id="a_upd" target="_blank">EDIT</a>|<a href="<?php echo base_url() ?>index.php/login/deletemanufacturer/?del=<?php echo $row->id ?>" id="a_del">DELETE</a>
